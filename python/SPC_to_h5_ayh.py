...
class Raman_Spectrum(object):
    ...
    def __init__(self, creation_time, filename, metadata, laserWl, laserPower, absLaserPower, grating, integrationTime,
...
def extractRamanSpc(path, bg_path = False, combine_statics = False, xaxis='wn'):
    ...
    for n, spcFile in enumerate(spcFiles):
        ...
        spectra.append(Raman_Spectrum(creation_time, filename, metadata, laserWl, laserPower, absLaserPower, grating, integrationTime, accumulations, nScans,
...
def populateH5(spectra, h5File):
    ...
    with h5py.File(h5File, 'w') as f:
        ...
        for n, spectrum in enumerate(spectra):
            ...
            attrs = {'creation_time'     : spectrum.creation_time,
...
# rootDir = r"R:\3-Temporary\aykh2\Renishaw\2020-01-26\2020-01-23-CB5-MV-crystallized"
# run(rootDir)
